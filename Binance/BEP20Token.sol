...
contract BEP20Token {
    string public name = "BEP20Token"; // Holds the name of the token
    string public symbol = "B2T"; // Holds the symbol of the token
    uint8 public decimals = 18; // Holds the decimal places of the token
